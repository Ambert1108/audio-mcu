...
namespace aesir {
    ...
    public:
        ...
        void loadTest() {
            ...
            whisper_context* ctx = whisper_init_from_file("/home/blueFlower/workspace/aesir/whispercpp/whisper.cpp-master/models/ggml-large-v3-turbo.bin");
        ...
        aesirTranscriber() {
            I_LOG("aesir transcriber constructed!");
        }
        ~aesirTranscriber() {
            I_LOG("aesir transcriber destructed!");
        }
        bool startup(const std::string& modelFile = "/home/blueFlower/workspace/aesir/whispercpp/whisper.cpp-master/models/ggml-large-v3-turbo.bin") {
            ...
            wparams.n_threads = 16;                  // 线程数（根据CPU核心调整）
        ...
        int shutdown() {
            if (wctx != nullptr) {
                whisper_free(wctx);
                wctx = nullptr;
                I_LOG("aesir shutdown: free success!");
            }
            else {
                I_LOG("aesir shutdown: no need to free!");
            }
    ...
    static aesirTranscriber transcriber;
}
